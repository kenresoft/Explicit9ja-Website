	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $onelatest => $onedata) {
      	# code...
			...
			<img src="blogadmin/images/'.$onedata['photo'].'" class="img-fluid" alt="fantastic cms" style="width:700px;height:300px">
			</a>
			</div>
      	...
      	# code...
			echo '<div class="col-md-6 card">
							<a href="single.php?id='.$cdata['id'].'">
								<img src="blogadmin/images/'.$cdata['photo'].'" class="card-img-top img-fluid" alt="fantastic cms" style="width:480px;height:180px">
							</a>
							<div class="card-body">
					...
					echo '<div class="blog-grids row mb-3">
							<div class="col-md-5 blog-grid-left">
								<a href="single.php?id='.$specificblog['id'].'">
									<img src="blogadmin/images/'.$specificblog['photo'].'" class="img-fluid" alt="fantastic cms" style="width:520px; height:200px;">
								</a>
							</div>
							<div class="col-md-7 blog-grid-right">
