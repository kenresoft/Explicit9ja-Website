...
$id = $_REQUEST['e-info'];
$query = "select tblsongs.id, tblsongs.likes, tblsongs.PostTitle as posttitle,tblsongs.PostImage,tblcategory.CategoryName as category,tblcategory.id as cid,tblsubcategory.Subcategory as subcategory,tblsubcategory.SubCategoryId as sid,tblsongs.PostDetails as postdetails,tblsongs.PostingDate as postingdate,tblsongs.PostUrl as url,tblsongs.File as file, tblsongs.Artist from tblsongs left join tblcategory on tblcategory.id=tblsongs.CategoryId left join  tblsubcategory on  tblsubcategory.SubCategoryId=tblsongs.SubCategoryId where tblsongs.id='$id'";
...
<head>
		...
		<?php include('includes/tag/music-tag.php'); ?>
	    <!-- Title -->
    <title>Explicit9ja.com | Music Detail</title>
...
<body>
		...
		<?php include('includes/share/music-share.php') ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-sm-2 col-xl-1">
                        ...
                        <div class="razo-author-avatar">
                            ...
                            <h6><?php echo htmlentities($row['Artist']); ?></h6>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-10 col-xl-9">
                            ...
                            <div class="post-catagories">
                               ...
                               <ul class="d-flexb flex-wrap align-items-center">
                                    ...
                                    <li><a style="color:#3498db;">FILE NAME : </a>
                                        <span class="wordwrap" style="color:#ffc400;"><?php echo htmlentities($fileinfo['filename']); ?></span>
                                    </li>
                                    <li>
                                        <a style="color:#3498db;">ARTIST :</a>
                                        <span style="color:#ffc400;"><?php echo htmlentities($fileinfo['tags']['id3v2']['artist']['0']); ?></span>
                                    </li>
                                    <li><a style="color:#3498db;">ALBUM :</a>
                                  <span style="color:#ffc400;"><?php echo htmlentities($fileinfo["tags"]["id3v2"]["album"]["0"]); ?></span>
                                    </li>
                                </ul>
                                 ...
                                 <ul class="d-flex flex-wrap align-items-center">
                                    ...
                                    <li><div>
                                        ...
                                        <div id="tutorial-<?php echo $res["id"]; ?>">
                                            ...
                                            <?php
                                            $query ="SELECT * FROM tblsong_likes_map WHERE song_id = '" . $res["id"] . "' and ip_address = '" . $ip_address . "'";
                        ...
                        <!-- Post Share -->
                           <div class="social-btns"> 
                            <h4 class="h">Share this music:</h4>
                    ...
                    <!--post share end-->
                        ...
                        <a href="media-download-music.php?remote_file_id=<?php echo $id; ?>">
